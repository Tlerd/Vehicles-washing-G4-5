...
* **Wireframe (Step 4 - Services)**:
    ...
    | [ ] Combo VW Detail Wash - 280k       | Undercarriage Wash:    50,000 |
    | [v] Undercarriage Wash - 50k                     |                    |
    |                                       | Total: 230,000 VND |
    |                                       | [ Continue ]       |
    +------------------------------------------------------------+
    ```
...
* **Back-end Development (Phat & Binh)**:
  ...
  * `[ ]` API Controller `/api/v1/bookings` to accept booking information: **Phat** (Lead) & **Binh** (Support/Review)
