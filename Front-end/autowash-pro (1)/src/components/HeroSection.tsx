...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_15%_25%,rgba(56,189,248,0.12),transparent_30%),radial-gradient(circle_at_85%_20%,rgba(14,165,233,0.10),transparent_28%),linear-gradient(135deg,#eef9ff_0%,#f9fbff_55%,#edf7fd_100%)]" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-12 lg:gap-8 items-center">
          ...
          <div className="flex flex-col items-start pt-8 lg:pt-0">
            <p className="hero-eyebrow mobile-animate text-sm font-bold text-primary uppercase tracking-[0.1em] mb-4">
              Premium car care, booked in minutes
            </p>
            <h1 className="hero-heading mobile-animate text-5xl md:text-6xl xl:text-7xl font-display font-extrabold text-text-primary leading-[1.05] tracking-tight mb-6 max-w-[700px]">
              A smarter way to <br className="hidden md:block" />book your car wash
            </h1>
            <p className="hero-desc-btn mobile-animate text-lg md:text-xl text-text-secondary leading-relaxed mb-8 max-w-[650px]">
              Instant booking, transparent pricing, real-time availability, and a loyalty program that rewards every visit.
            </p>
            ...
            <div className="hero-desc-btn mobile-animate flex flex-wrap items-center gap-4 mb-12">
              <button 
                onClick={(e) => {
                  e.preventDefault();
                  document.querySelector('#hero-booking')?.scrollIntoView({ behavior: 'smooth' });
                }}
            ...
            <div className="hero-desc-btn mobile-animate grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 pt-8 border-t border-border/60 w-full max-w-[650px]">
              <div>
                <p className="text-3xl md:text-4xl font-display font-bold text-text-primary mb-1">10,000+</p>
                <p className="text-sm text-text-secondary font-medium">Happy wash sessions</p>
              </div>
              <div>
                <p className="text-3xl md:text-4xl font-display font-bold text-text-primary mb-1">15–35<span className="text-xl md:text-2xl text-text-secondary font-medium ml-1">min</span></p>
                <p className="text-sm text-text-secondary font-medium">Average turnaround</p>
              </div>
              <div className="col-span-2 md:col-span-1">
                <p className="text-3xl md:text-4xl font-display font-bold text-text-primary mb-1">2</p>
                <p className="text-sm text-text-secondary font-medium">Branches in HCMC</p>
              </div>
            </div>
          </div>
