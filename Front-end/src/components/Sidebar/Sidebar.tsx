      ...
      >
        <div className={styles.logo}>
          ...
          <div className={styles.logoActions}>
            {onToggle && (
              <button type="button" className={styles.toggleBtn} onClick={onToggle} aria-label="Thu gọn menu">
                {collapsed ? '→' : '←'}
              </button>
            )}
            {onCloseMobile && (
              <button type="button" className={styles.mobileCloseBtn} onClick={onCloseMobile} aria-label="Đóng menu">
                ✕
              </button>
            )}
          </div>
        ...
        <div className={styles.sidebarIntro}>
          {!collapsed ? (
            <>
              ...
              <span>Truy cập nhanh đặt lịch, xe đã lưu và quyền lợi thành viên.</span>
            </>
          ) : (
